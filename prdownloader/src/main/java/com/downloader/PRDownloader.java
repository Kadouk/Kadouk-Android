...
public class PRDownloader {
    ...
    public static DownloadRequestBuilder download1(String url, String dirPath, String fileName) {
        return new DownloadRequestBuilder(url, dirPath, fileName);
    }
    ...
    public static DownloadRequest[] getAll(){
        return DownloadRequestQueue.getInstance().getAll();
    }
